  ...
  return (
    ...
    >
      ...
      <div className="nowplaying-body">
        <div className="nowplaying-bar-top">
          <div className="nowplaying-marquee">
            {currentTrack ? (
              <span className="marquee-text">{currentTrack.title} — {currentTrack.artist}</span>
            ) : (
              <span className="marquee-text" style={{color: 'var(--text-tertiary)'}}>No track selected</span>
            )}
          </div>
          <ProgressBar />
        </div>

        <div className="nowplaying-bar-main">
          <div className="nowplaying-main-right">
